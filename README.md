La repositories contiene 4 file di cui:
  - PMCSNFinaleSenzaLibrerie.ipynb: E il codice in python della simualazione senza le librerie utilizzate, comprende:
     - codice simulazione modello base e migliorativo
     - verifica,
     - validazione
